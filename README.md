...
sudo iptables -L  # to list the current iptables configuation
sudo iptables -nvL # list a more detailed version of above with packet counters.  This is very helpfull for 
